...
(function ($) {
    ...
    $.fn.pdfViewer = function (url, options) {
        ...
        $(this).append('<div class="pdf-toolbar d-flex justify-content-center">' +
            '<span class="btn btn-pdf-preview-sm btn-secondary mx-1" id="btn-print" title="Print"><i class="fa-solid fa-print"></i></span>' +
            '<span class="btn btn-pdf-preview-sm btn-secondary mx-1" id="btn-download" title="Download"><i class="fa-solid fa-file-arrow-down"></i></span>' +
            '<span class="btn btn-pdf-preview-sm btn-primary mx-1 ml-4" id="btn-first" title="First page"><i class="fa-solid fa-angles-left"></i></span>' +
            '<span class="btn btn-pdf-preview-sm btn-primary mx-1" id="btn-prev" title="Previous page"><i class="fa-solid fa-chevron-left"></i></span>' +
            '<span class="text-black text-center mx-1 mt-2" id="current-page">0</span>' +
            '<span class="text-black text-center mx-1 mt-2" >of</span>' +
            '<span class="text-black text-center mx-1 mt-2" id="page-number">0</span>' +
            '<span class="btn btn-pdf-preview-sm btn-primary mx-1" id="btn-next" title="Next page"><i class="fa-solid fa-chevron-right"></i></span>' +
            '<span class="btn btn-pdf-preview-sm btn-primary mx-1" id="btn-last" title="Last page"><i class="fa-solid fa-angles-right"></i></span>' +

            '<select class="form-control-sm mx-1 ml-4" id="zoom-list"><option value="0.25">25%</option><option value="0.50">50%</option><option value="0.75">75%</option><option value="1">100%</option><option value="1.25">125%</option><option value="1.50">150%</option><option value="2.0">200%</option></select>' +
            '<span class="btn btn-pdf-preview-sm btn-secondary mx-1" id="btn-zoom-in" title="Zoom In"><i class="fa-solid fa-magnifying-glass-plus"></i></span>' +
            '<span class="btn btn-pdf-preview-sm btn-secondary mx-1" id="btn-zoom-out" title="Zoom Out"><i class="fa-solid fa-magnifying-glass-minus"></i></span>' +
            '<span class="btn btn-sm btn-danger mx-1 float-end preview-close-btn"title="Close" onclick="profileCloseButton()"><i class="fa-solid fa-xmark"></i></span>' +
            '</div>');

            // $(this).append('<div class="pdf-toolbar d-flex justify-content-center">' +
            // '<span class="btn btn-sm btn-secondary mx-1" id="btn-print" title="Print"><i class="fa-solid fa-print"></i></span>' +
            // '<span class="btn btn-sm btn-secondary mx-1" id="btn-download" title="Download"><i class="fa-solid fa-file-arrow-down"></i></span>' +
            // '<span class="btn btn-sm btn-primary mx-1" id="btn-first" title="First page"><i class="fa-solid fa-angles-left"></i></span>' +
            // '<span class="btn btn-sm btn-primary mx-1" id="btn-prev" title="Previous page"><i class="fa-solid fa-chevron-left"></i></span>' +
            // '<span class="btn btn-sm btn-primary mx-1" id="btn-next" title="Next page"><i class="fa-solid fa-chevron-right"></i></span>' +
            // '<span class="btn btn-sm btn-primary mx-1" id="btn-last" title="Last page"><i class="fa-solid fa-angles-right"></i></span>' +
            // '<input type="number" class="form-control-sm" placeholder="0" id="current-page"><span id="page-number-sep">of</span> ' +
            // '<span class="text-white" id="page-number">0</span>' +
            // '<select class="form-control-sm mx-1" id="zoom-list"><option value="0.25">25%</option><option value="0.50">50%</option><option value="0.75">75%</option><option value="1">100%</option><option value="1.25">125%</option><option value="1.50">150%</option><option value="2.0">200%</option></select>' +
            // '<span class="btn btn-sm btn-secondary mx-1" id="btn-zoom-in" title="Zoom In"><i class="fa-solid fa-magnifying-glass-plus"></i></span>' +
            // '<span class="btn btn-sm btn-secondary mx-1" id="btn-zoom-out" title="Zoom Out"><i class="fa-solid fa-magnifying-glass-minus"></i></span>' +
            // '</div>');
